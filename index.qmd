...
:::{.callout-note}
Delhi's PM~2.5~ shows 2.5-4x national standards; we built a model using land use, traffic, and population data that predicts pollution at fine spatial resolution across the city, which can help identify hotspots.
:::
