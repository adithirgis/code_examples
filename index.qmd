...
df <- data.frame(
  Category = c(
    ...
    "\U1F30D Geography",
    "\U1F30D Geography",
    "\U1F3ED Emission source",
    "\U1F303 Urban activity",
    "\U1F6F0 Satellite",
    "\u2601 Atmospheric",
    "\U1F326 Meteorology",
    "\U1F326 Meteorology",
  ...
  Why = c(
    ...
    "Water bodies enhance atmospheric mixing and generally reduce nearby particulate pollution.",
    "Bare surfaces may either generate wind-blown dust or have little influence depending on local conditions.",
    "Cropland generally has lower emission intensity than urbanized land and may reduce PM\u2082.\u2085.",
    "Natural vegetation promotes pollutant deposition and improves dispersion.",
    "Higher elevations generally have lower PM\u2082.\u2085 because of better atmospheric ventilation.",
    "Represents large-scale spatial gradients in air pollution.",
    "Represents large-scale spatial gradients in air pollution.",
    "Industrial facilities emit particulate matter and precursor pollutants, with concentrations decreasing as distance increases.",
    "Night-time lights indicate urbanization and human activity associated with higher emissions.",
    "Tropospheric NO\u2082 is a strong indicator of combustion-related emissions and is positively associated with PM\u2082.\u2085.",
    "Higher aerosol optical depth reflects greater atmospheric aerosol loading and is positively associated with PM\u2082.\u2085.",
    "Higher temperatures generally enhance atmospheric mixing and reduce near-surface PM\u2082.\u2085.",
    "Higher atmospheric pressure suppresses vertical mixing, favouring pollutant accumulation.",
    "Eastward winds enhance pollutant dispersion and reduce local PM\u2082.\u2085.",
    "Northward winds enhance pollutant dispersion and reduce local PM\u2082.\u2085.",
    "Higher wind speeds improve atmospheric ventilation and reduce pollutant accumulation.",
    "Precipitation removes particulate matter through wet deposition."
  )
)
...
::: {.callout-note}
Predictors like land use, NDVI are extracted using circular buffers centred on each monitoring site.
:::
