...
- First, source the [functions.R](https://github.com/adithirgis/code_examples/blob/main/R/functions.R) file that has custom-functions and loads the required libraries. 
...
## Check the desired direction of sign of effect
...
## View railway lengths inside of buffer of radius 1000 m (interactive map)
...
dataframe_selected_params_p_vif <- remove_p_value(my_model_built, dataframe_selected_params_p_vif, 0.1)
data_to_check_for_direction_of_effect_after_cleaning <- vars(my_model_built, sig_star, direction_of_effect_table)
