...
var composite1 = AODmaskQ.mean().multiply(0.001).clip(geometry1)
var composite2 = AODwithoutmask.mean().multiply(0.001).clip(geometry1)
...
Export.image.toDrive({
  image:composite1, 
  description: 'Bengaluru_AOD_map_August2022',
  scale: 1000,
